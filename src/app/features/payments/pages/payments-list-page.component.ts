...
@Component({ selector: 'app-payments-list-page', imports: [RouterLink, PageHeaderComponent, LoadingStateComponent, EmptyStateComponent, ErrorStateComponent, StatusBadgeComponent], template: `
  <app-page-header title="Pagos" description="Consulta los pagos registrados y sus comprobantes.">@if (canRegister) { <a class="btn btn-primary" routerLink="/payments/new">Registrar pago</a> }</app-page-header>
